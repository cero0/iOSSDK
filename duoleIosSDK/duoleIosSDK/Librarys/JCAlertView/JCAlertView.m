...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(JCAlertViewButtonType)buttonType{
    ...
    switch (buttonType) {
        case JCAlertViewButtonTypeDefault:
            normalImage = [self createImageWithColor:JCColor(34, 44, 60)];
            highImage = [self createImageWithColor:JCColor(30, 40, 56)];
            textColor = JCColor(255, 255, 255);
            break;
        case JCAlertViewButtonTypeCancel:
            normalImage =[self createImageWithColor:JCColor(130, 130, 130)];
            highImage = [self createImageWithColor:JCColor(140, 150, 160)];
            textColor = JCColor(255, 255, 255);
            break;
        case JCAlertViewButtonTypeWarn:
            normalImage = [self createImageWithColor:JCColor(160, 20, 36)];
            highImage = [self createImageWithColor:JCColor(140, 20, 30)];
            textColor = JCColor(255, 255, 255);
            break;
    }
